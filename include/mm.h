...
// Constants for TLB configuration
#define NUM_SETS 16       // Number of sets in the TLB
#define ENTRIES_PER_SET 2 // Number of entries per set (2-way set associativity)
#define ENTRY_SIZE 16     // total bytes per TLB entry
#define PID_OFFSET 0      // PID starts at byte 0
#define VPN_OFFSET 4      // VPN starts after PID
#define PFN_OFFSET 8      // PFN starts after VPN
#define VALID_OFFSET 12   // Valid bit position
